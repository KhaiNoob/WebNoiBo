...
## 1. Cài đặt dotnet
<p> Tải dotnet theo đường dẫn sau: https://dotnet.microsoft.com/en-us/download</p><br>
    Tiến hành cài đặt dotnet.

## 2. Cài đặt hệ quản trị cơ sở dữ liệu SQL Sever và cơ sở dữ liệu
<p> Tải SQL Server theo đường dẫn sau: https://www.microsoft.com/en-us/sql-server/sql-server-downloads</p>
